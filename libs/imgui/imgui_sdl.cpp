				...
				else
				{
					...
					for (unsigned int i = 0; i + 3 <= drawCommand->ElemCount; i += 3)
					{
						...
						if (i + 6 <= drawCommand->ElemCount)
						{
							...
							if (isUniformColor && bounding.IsOnExtreme(v0.pos) && bounding.IsOnExtreme(v1.pos) && bounding.IsOnExtreme(v2.pos) && bounding.IsOnExtreme(v3.pos) && bounding.IsOnExtreme(v4.pos) && bounding.IsOnExtreme(v5.pos))
							{
